# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 21:10:17 2018
...
undist_test_imgs = cal_undistort(test_imgs)  
...
color_bin = color_white_yellow_binary(undist_test_imgs)
...
# plt.imsave('output_images/test2_color.jpg',color_bin)
...
ax2.set_title('Color Thresholding Mask', fontsize=25) 
...
combined_binary[(grad_combined == 1) | (color_bin == 1)] = 1
...
color_binary = np.dstack(( np.zeros_like(grad_combined), grad_combined, color_bin)) * 255
